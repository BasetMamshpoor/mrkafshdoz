                    ...
                    <div className={style.fields}>
                        ...
                        <div className={style.media}>
                            ...
                            <div className={style.wrapper}>
                                <Image ref={wrapper}
                                    src={!state ? imagePlaceholder : !!state.icon ? state.icon : imagePlaceholder} unoptimized={true}
                                    alt={'i.name'} width={0} height={0} sizes='100vw' className='w-full h-full object-cover' />
                            </div>
                        </div>
