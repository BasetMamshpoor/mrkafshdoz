...
const NewSlide = ({ data, setData, setIsOpen, SwalStyled, reload }) => {
    ...
    const handleUpload = (e, t) => {
        ...
        const allowed_format = ['jpg', 'jpeg', 'png', 'webp','gif']
            ...
            <div className={style.hVhBe3q}>
                <form className={style.e1Wz0E} onSubmit={handleSubmit}>
                    <div className={style.upload}>
                        <input type="file" hidden id='file' accept='image/*' onChange={(e) => handleUpload(e, 'target')} />
                        <div className={style.drag_drop} onDragOver={e => e.preventDefault()} onDrop={(e) => handleUpload(e, 'dataTransfer')}>
                            ...
                            <div className={style.icon} >
                                <Image ref={wrapper} src={!data ? imagePlaceholder : !!data.src ? data.src : imagePlaceholder}
                                    width={0} height={0} sizes='100vw' className='w-full h-full object-cover' placeholder='blur' blurDataURL={imagePlaceholder} alt='' />
                            </div>
