...
const Filters = ({ category, setIsOpen }) => {
            ...
            {!!data ? <div className={style.filters}>
                ...
                <div className={style.discount}>
                    <div className={style.dis_field}>
                        ...
                        <Switch isSelected={filters['discount'] ? true : false} onValueChange={checked => checked ? handleFilter('discount', true) : handleFilter('discount', null)} color='success' />
                    </div>
                </div>
