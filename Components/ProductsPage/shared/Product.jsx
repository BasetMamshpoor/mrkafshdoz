...
const Product = ({ id, name, price, rate, offPercent, offPrice, image, off_date_to, is_available, is_major }) => {
            ...
            <div className={style.Xqera}>
                <Link href={`/products/${id}`}>
                    <div className={style.imgP}>
                        <Image placeholder='blur' blurDataURL='/Images/placeholder-1.png' width={0} height={0} sizes='100vw' className='w-full h-full object-cover' src={image||'/Images/placeholder-1.png'} alt="" />
                    </div>
