...
export default function FooterSection() {
    ...
    return (
        <footer className="bg-main  bg-gradient-to-t text-white py-8 pb-20 md:pb-8 mt-6" dir="ltr">
            <div className="container grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 sm:gap-8 gap-3 text-[12px] md:items-start px-4 sm:px-auto">
                <div
                ...
                >
                    ...
                    <p className="flex items-center mb-2">آدرس:تهران خیام روبه‌رو مترو خیام کوچه شاهرخ شاهی انتهایی کوچه پلاک۲۰ </p>
