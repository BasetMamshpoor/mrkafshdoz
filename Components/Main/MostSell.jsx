            ...
            <div className="container lg:mb-[140px] sm:my-20 my-[60px]" dir='rtl'>
                <div className="w-full mx-auto flex flex-col gap-4">
                    <div className="flex items-center justify-between px-4">
                        ...
                        <Link href={`/category-${categories[0]?.slug}-apparel?sort=${url}`} className='centerOfParent sm:text-base text-[12px] gap-2 text-primary-600 whitespace-nowrap'>مشاهده همه <BiLeftArrowAlt className='w-5 h-5 fill-primary-600' /></Link>
                    </div>
                                    ...
                                    <SwiperSlide key={i} dir='ltr' className={`relative select-none overflow-hidden flex flex-col items-stretch sm:gap-3 gap-4 sm:max-w-[302px] w-full h-[405px] sm:h-[528px] flex-shrink-0 rounded-lg md:p-6 p-4 bg-white`}>
                                        ...
                                        <div className="grow flex flex-col gap-4 mt-4">
                                            ...
                                            <div className="flex items-center sm:gap-6 w-full">
                                                <Skeleton className='sm:text-base text-[12px] sm:h-12 h-8 flex-[1_0_0] sm:px-6 px-4 sm:py-4 py-2 rounded ' />
                                            </div>
                                        </div>
                                    </SwiperSlide>
                                )
                                            ...
                                            <div className="grow w-full flex flex-col items-stretch justify-between">
                                                ...
                                                <div className="w-full flex flex-col items-end" dir='rtl'>
                                                    {p.price !== p.offPrice && <div className="flex items-center gap-4">
                                                        <span className='py-[2px] px-2 rounded-lg bg-red-50 text-red-600 sm:text-sm text-[12px] inline-block'>{Math.ceil(((p.price - p.offPrice) / p.price) * 100)}%</span>
                                                        <del className={`text-red-300 sm:text-sm text-[12px] hasToman`}>{addComma(p.price)}</del>
                                                    </div>}
                                                ...
                                                <div className="flex items-center sm:gap-6 gap-4 w-full mt-2">
                                                    <div className='hover:bg-primary-500 hover:text-white duration-300 sm:text-base text-[12px] sm:h-12 h-8 flex-[1_0_0] sm:px-6 px-4 sm:py-4 py-2 rounded border-primary-500 sm:border-[1.5px] border text-primary-500 centerOfParent'>مشاهده</div>
                                                </div>
                                            </div>
                                        </Link>
                                    </SwiperSlide>
