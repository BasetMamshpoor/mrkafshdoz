...
import Products from 'Components/Wholesale/Products';
        ...
        <>
            <section className={style.productList} dir="rtl">
                <div className="container flex flex-col items-stretch gap-4">
                    <div className="centerOfParent mt-6">
                        <h1 className='sm:text-2xl font-bold '>فروش عمده</h1>
                    </div>
                    <div className='row'>
                        <div className='col-lg-3'>
                            {!isMatch && <Filters isWholeSale />}
                        </div>
